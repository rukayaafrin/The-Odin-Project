...
RSpec.describe 'Hash Exercises' do
  ...
  describe 'pick siblings exercise' do

    it 'returns a hash with the siblings' do
      family_hash = {  uncles: ["bob", "joe", "steve"],
            sisters: ["jane", "jill", "beth"],
            brothers: ["frank","rob","david"],
            aunts: ["mary","sally","susan"]
          }
      expect(pick_siblings(family_hash)).to eq({ sisters: ["jane", "jill", "beth"], brothers: ["frank","rob","david"] })
    end
